    ...
    <div class="database-example pa-6 ma-6 max-w-4xl">
      ...
      <div v-if="isConnected" class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="pa-4 border rounded-lg">
          ...
          <div class="space-y-2">
            ...
            <textarea 
              ...
              placeholder="角色设定" 
              class="w-full p-2 border rounded text-sm h-20"
            ></textarea>
            <textarea 
              v-model="newCharacter.greeting" 
              placeholder="问候语" 
              class="w-full p-2 border rounded text-sm h-16"
            ></textarea>
            <label class="flex items-center text-sm">
              <input 
                v-model="newCharacter.isPlayer" 
                type="checkbox" 
                class="mr-2"
              >
              设为主角
        ...
        <div class="pa-4 border rounded-lg">
          ...
          <div class="mb-4 max-h-40 overflow-y-auto">
            <div v-for="entry in worldbooks" :key="entry.id" class="mb-2 p-2 bg-gray-50 rounded">
              <div class="flex justify-between items-center">
                ...
                <button 
                  @click="deleteWorldbook(entry.id)" 
                  class="text-red-500 hover:text-red-700 text-sm"
                >
                  删除
                </button>
          ...
          <div class="space-y-2">
            <input 
              v-model="newWorldbook.keywords" 
              placeholder="关键词 (用逗号分隔)" 
              class="w-full p-2 border rounded text-sm"
            >
            <textarea 
              v-model="newWorldbook.content" 
              placeholder="设定内容" 
              class="w-full p-2 border rounded text-sm h-20"
            ></textarea>
            <button 
